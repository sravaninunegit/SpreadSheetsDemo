...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DisplayFromExel.Model.OrgAdapter, DisplayFromExel", OrgAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == OrgAdapter.class) {
			mono.android.TypeManager.Activate ("DisplayFromExel.Model.OrgAdapter, DisplayFromExel", "", this, new java.lang.Object[] {  });
		}
	}
