...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DisplayFromExel.Model.EmpAdapter, DisplayFromExel", EmpAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == EmpAdapter.class) {
			mono.android.TypeManager.Activate ("DisplayFromExel.Model.EmpAdapter, DisplayFromExel", "", this, new java.lang.Object[] {  });
		}
	}
